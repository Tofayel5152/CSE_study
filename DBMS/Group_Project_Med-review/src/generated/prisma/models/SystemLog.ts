...
export type SystemLogWhereInput = {
  ...
  logId?: Prisma.UuidFilter<"SystemLog"> | string
  userId?: Prisma.UuidNullableFilter<"SystemLog"> | string | null
  action?: Prisma.StringFilter<"SystemLog"> | string
  severity?: Prisma.EnumLogSeverityFilter<"SystemLog"> | $Enums.LogSeverity
  details?: Prisma.StringFilter<"SystemLog"> | string
...
export type SystemLogScalarWhereWithAggregatesInput = {
  ...
  logId?: Prisma.UuidWithAggregatesFilter<"SystemLog"> | string
  ...
  severity?: Prisma.EnumLogSeverityWithAggregatesFilter<"SystemLog"> | $Enums.LogSeverity
  details?: Prisma.StringWithAggregatesFilter<"SystemLog"> | string
...
export type SystemLogOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"logId" | "userId" | "action" | "severity" | "details" | "ipAddress" | "createdAt", ExtArgs["result"]["systemLog"]>
...
export interface SystemLogDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const systemLogWithLogIdOnly = await prisma.systemLog.findMany({ select: { logId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many SystemLogs and only return the `logId`
   * const systemLogWithLogIdOnly = await prisma.systemLog.createManyAndReturn({
   *   select: { logId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more SystemLogs and only return the `logId`
   * const systemLogWithLogIdOnly = await prisma.systemLog.updateManyAndReturn({
   *   select: { logId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface SystemLogFieldRefs {
  readonly logId: Prisma.FieldRef<"SystemLog", 'String'>
  readonly userId: Prisma.FieldRef<"SystemLog", 'String'>
  readonly action: Prisma.FieldRef<"SystemLog", 'String'>
  readonly severity: Prisma.FieldRef<"SystemLog", 'LogSeverity'>
